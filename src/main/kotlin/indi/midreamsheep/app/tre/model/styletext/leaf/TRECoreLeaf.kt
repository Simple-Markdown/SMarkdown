package indi.midreamsheep.app.tre.model.styletext.leaf
...
open class TRECoreLeaf(private val content:String,private val offsetMapping: StyleTextOffsetMapping): TRECoreStyleTextRoot() {
     ...
     * 源文本到转换后文本的偏移
     * */
    override fun originalToTransformed(offset: Int): Int = offset+offsetMapping.transformedOffsetStart

    /**
     * 转换后文本到源文本的偏移
     * */
    override fun transformedToOriginal(offset: Int): Int = offset+offsetMapping.originalOffsetStart
}