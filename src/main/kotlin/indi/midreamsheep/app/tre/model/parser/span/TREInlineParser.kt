...
class TREInlineParser {
    ...
    ): List<TREStyleTextTree>
    {
        ...
        while(true) {
            ...
            val spanList:MutableList<indi.midreamsheep.app.tre.model.parser.InlineParser> = mutableListOf()
            spanParsers.forEach {
            ...
            var weight = 0
            var parser: indi.midreamsheep.app.tre.model.parser.InlineParser? = null
            spanList.forEach {
